...
\item{Gaussian filter + thresholding: \cite{merriman1992diffusion,merriman1994motion} }
\item{Other discrete approaches: \cite{schoenemann09linear} 
\cite{zehiry10fast}
\cite{nieuwenhuis14efficient} \cite{antunes19} \cite{antunes20}}
\item high order threshold dynamics \cite{esedoglu2005threshold,esedoglu2008threshold}
\end{itemize}}
\end{itemize}}
%
%
